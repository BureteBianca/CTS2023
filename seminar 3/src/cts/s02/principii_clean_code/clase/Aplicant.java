...
public abstract class Aplicant{
	...
	public static int sumaFinantata;
	...
	public void aplicareStatus(){
		if(this.punctaj>Aplicant.pragPunctaj)
			System.out.println("Aplicantul "+nume+" "+prenume+" a fost acceptat.");
		else
			System.out.println("Aplicantul "+nume+" "+prenume+" nu a fost acceptat.");
		System.out.println("Aplicantul "+this.nume+" "+this.prenume+(this.punctaj>Aplicant.pragPunctaj ? " " : " nu ")+" nu a fost acceptat.");
	...
	protected void afisareFinantare(String tipaplicant, int sumaFinantata){
		System.out.println(this.nume+" "+this.prenume+" primeste"+sumaFinantata+" Euro/zi in proiect.");
